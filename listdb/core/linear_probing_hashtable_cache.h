...
#endif
#ifndef LISTDB_LINEAR_PROBING_HASHTABLE_PROBING_DISTANCE
#define LISTDB_LINEAR_PROBING_HASHTABLE_PROBING_DISTANCE 16
#endif
...
class LinearProbingHashTableCache {
 ...
 private:
  const static int probing_distance_ = LISTDB_LINEAR_PROBING_HASHTABLE_PROBING_DISTANCE;
